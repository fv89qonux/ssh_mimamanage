...
<body>
			...
			<form class="form form-horizontal"
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8">
						<input id="" name="util.s_0" type="text" placeholder="账户"
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8">
						<input id="" name="util.s_1" type="password" placeholder="密码"
							class="input-text size-L">
					</div>
				</div>
				<div class="row cl">
				...
				<div class="row cl">
					<div class="formControls col-xs-8 col-xs-offset-3">
						<input name="" type="submit" class="btn btn-success radius size-L"
							...
							value="&nbsp;取&nbsp;&nbsp;&nbsp;&nbsp;消&nbsp;"> <font
							style="margin-left:20px;" color=red><s:property
								value="errMsg" /> </font>
					</div>
				</div>
			</form>
	...
	<div class="footer">Copyright 2020 BYSJ</div>
